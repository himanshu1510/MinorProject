...
export const isUserValid = (mobile, callback) => async dispatch => {
  try {
    ...
    axios
      .get('https://d45a-183-83-43-232.ngrok.io/api/customers')
      .then(response => {
...
export const addVoter = (voterId, length) => async dispatch => {
  try {
    ...
    axios
      .post('https://d45a-183-83-43-232.ngrok.io/api/addcustomer', {
        firstname: 'anonymous',
        lastname: 'anonymous',
        mobile: voterId,
        id: length + 1,
...
export const castVote = (id, voterId, length, callback) => async dispatch => {
  try {
    ...
    axios
      .post('https://d45a-183-83-43-232.ngrok.io/api/castvote/' + id)
      .then(response => {
